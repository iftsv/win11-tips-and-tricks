...
1. Install this tool [SteamDesktopAuthenticator 1.0.14](https://github.com/Jessecar96/SteamDesktopAuthenticator/releases/tag/1.0.14). Note: use only from this repo!
